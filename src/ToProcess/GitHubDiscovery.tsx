...
export default function GitHubDiscovery({ 
  ...
  const [totalPages, setTotalPages] = useState(5); // Mock for pagination, would be calculated from API response
  ...
  const handleSemanticSearch = async () => {
    ...
    setIsLoading(true);
    // This would call an API that uses LLM processing for semantic search
    // For now, let's just mock it with regular search
            ...
            <div className="flex justify-center mt-8">
              <div className="flex items-center space-x-2">
                ...
                {[...Array(Math.min(totalPages, 5))].map((_, i) => {
                  ...
                  // If current page is near the start, show pages 1-5
