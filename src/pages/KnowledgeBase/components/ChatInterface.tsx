      ...
      <form onSubmit={handleSubmit} className="border-t border-gray-700/30 p-4">
        <div className="flex items-center">
          <input
            ...
            placeholder="Ask about retrieving content or managing your knowledge base..."
        ...
        <p className="text-xs text-gray-400 mt-2">
          Tip: You can ask to retrieve content from websites, codebases, YouTube videos, or documents.
        </p>
      </form>
    </div>
  );
